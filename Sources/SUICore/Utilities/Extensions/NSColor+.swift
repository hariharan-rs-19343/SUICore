...
//  SUICore
//
//  Created by Hariharan R S on 01/09/26.
//
...
public extension NSColor {
    ...
    private static func setAppearance(dark: NSColor, light: NSColor) -> NSColor {
    ...
    static func setColor(dark: NSColor, light: NSColor) -> NSColor {
